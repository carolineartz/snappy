...
class CLIPTokenizer {
    ...
    init(resourcesPath: String) {
        let mergesURL = URL(fileURLWithPath: resourcesPath).appendingPathComponent("clip-merges.txt")
        let vocabURL = URL(fileURLWithPath: resourcesPath).appendingPathComponent("clip-vocab.json")
